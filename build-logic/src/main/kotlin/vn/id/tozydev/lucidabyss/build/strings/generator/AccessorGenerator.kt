...
internal fun generateAccessorCode(
    packageName: String,
    ...
    objectType.addProperty(
        PropertySpec
            .builder("current", localizedStringsClass)
...
private fun addDelegateObjectProperty(
    typeSpec: TypeSpec.Builder,
    name: String,
    node: Node.Object,
    packageName: String,
...
private fun addDelegateStringProperty(
    typeSpec: TypeSpec.Builder,
    name: String,
...
private fun addDelegateMultipartFunction(
    typeSpec: TypeSpec.Builder,
    name: String,
